...
### 13.2 The divergence micro-template (added 2026-07-28, v2.1.0)
...
3. **Likely overpowering forces** — named, ranked candidates for what dominated instead (Analyst inference, confidence-labelled per §5).
4. **What would confirm** — the specific future observation that would support this read.
...
A divergence written as a bare observation ("X rose but Y fell") without the rest of this template is incomplete — it names a puzzle without doing the work of trying to solve it.
